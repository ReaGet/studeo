  ...
  <div class="flex flex-col">
    ...
    <div class="flex flex-col py-2 gap-2">
      ...
      >
        ...
        <div class="flex items-center h-full py-3 px-4 bg-gray-100 rounded-xl">{{ item.time }}</div>
        <div
...
export default {
  ...
  computed: {
    dayOfWeek() {
      ...
      return new Intl.DateTimeFormat('ru-RU', options).format(this.daySchedule.timestamp);
    },
    date() {
      return new Intl.DateTimeFormat('ru-RU').format(this.daySchedule.timestamp);
    },
  },
};
</script>
